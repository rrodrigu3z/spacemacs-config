   ...
   '(
     ...
     (auto-completion :variables
                      ...
                      auto-completion-private-snippets-directory '(
                        ...
                        "~/.yasnippets/plugins/yasnippet/snippets"
                        "~/.yasnippets/ember-snippets"
                        "~/.yasnippets/yasnippet/yasmate/snippets"
                        ;; yasmate-rails (fix, use ruby-mode)
                        "~/.yasnippets/yasmate/snippets-rails"
                      ))
     ;; better-defaults
     emacs-lisp
     git
...
values."
  ...
  (setq-default
   ...
   ;; define the position to display `  ', options are `bottom', `top',
...
you should place your code here."
  ...
  ;;----------------------------------------------------------------------------
  ;; Fix lockfiles and backups (fix for Ember)
  ;;----------------------------------------------------------------------------
...
(defun sk/open-line-above (args)
  ...
  (if (equal args '(4))
    ...
    (indent-according-to-mode)))
;; TODO: Move to custom layer
;; Taken from sanityinc/init-editing-utils.el
(defun sanityinc/newline-at-end-of-line ()
  "Move to end of line, enter a newline, and reindent."
  (interactive)
  (move-end-of-line 1)
  (newline-and-indent))
;; TODO: Move to cusotm layer
;; Taken from sanityinc/init-editing-utils.el
...
;; Taken from sanityinc/init-paredit.el
(defun maybe-map-paredit-newline ()
  (unless (or (memq major-mode '(inferior-emacs-lisp-mode cider-repl-mode))
              (minibufferp))
    (local-set-key (kbd "RET") 'paredit-newline)))
;; TODO: Move to custom ruby config
